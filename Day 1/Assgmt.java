...
class Student1 {
 ...
 public static void main (String [] args){
    Student1 s1 = new Student1("Dorian" , 92, 987654321, "Birmingham");
    Student1 s2 = new Student1("Ronnie", 98, 912345678, "USA");
    s1.display();
    s2.display();
 }
}
...
class Employee {
  ...
  double salary;
   ...
   Employee(){
    System.out.println("No Argument COnstructor data");
    this.name = "unknown";
    this.emp_id = 0;
   ...
   Employee( String name,int emp_id,String designation,int salary){
    this.name = name;
    this.emp_id = emp_id;
   ...
   public static void main (String [] args){
     ...
     Employee emp3 =  new Employee(emp2);
      ...
      System.out.println("Employee 1:");
        ...
        System.out.println("Employee 3 (Copy of Employee 2):");
        emp3.displayDetails();
...
public class Main { //(Assume that I have created this file and running as a separate file with one public class)
  ...
  public static void main(String[]args){
    ...
    Vehicle v2 = new Vehicle("Jaguar",400000);
    Vehicle v3 = new Vehicle("Porsche",450000);
